...
\begin{document}
	...
	\begin{figure}
		\centering				
		\includegraphics[width=\linewidth]{../eval/results-img-graphs/SMSW.jpg}
		\captionof {Figure 2: }{MAP depending in the number of input system and indexing and retrieval settings}				
		\label{fig:SMSW}					
	\end{figure}
