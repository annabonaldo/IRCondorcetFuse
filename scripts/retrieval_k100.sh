...
cd $TERRIER_RESULTS
cd ..
rm -r ../../results/FusionIn/runBasic_k100
mkdir ../../results/FusionIn/runBasic_k100
cp -r results/* ../../results/FusionIn/runBasic_k100
...
cd $TERRIER_RESULTS
cd ..
rm -r ../../results/FusionIn/runQE_k100
mkdir ../../results/FusionIn/runQE_k100
cp -r results/* ../../results/FusionIn/runQE_k100
